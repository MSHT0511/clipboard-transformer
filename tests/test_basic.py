...
class TestTransformerLoadRules:
    ...
    def test_load_unknown_rule_type(self):
        ...
        rules_config = [
            {"name": "valid-rule", "type": "literal", "from": "foo", "to": "bar", "enabled": True},
            {
                "name": "unknown-rule",
                "type": "unknown_type",  # 未知のタイプ
                "some_field": "value",
            },
            {"name": "another-valid", "type": "regex", "pattern": r"\d+", "replacement": "NUM", "enabled": True},
        ]
    ...
    def test_load_rule_with_exception(self):
        ...
        rules_config = [
            ...
            {"name": "another-valid", "type": "literal", "from": "hello", "to": "hi", "enabled": True},
        ]
